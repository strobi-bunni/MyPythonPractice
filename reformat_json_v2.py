...
if __name__ == '__main__':
    ...
    indent_options.add_argument('-i', '--indent', metavar='INDENT', type=int, default=4,
                                help='들여쓰기 크기(기본값: 4)')
    ...
    output_options.add_argument('-o', '--outfile', type=argparse.FileType('w', encoding='utf-8'), default=sys.stdout,
                                help='출력할 파일')
