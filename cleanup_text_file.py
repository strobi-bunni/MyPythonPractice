...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--tab-size", type=int, default=4, help="탭 크기(탭을 공백으로 변경하지 않으려면 0을 입력) (default: 4)")
    parser.add_argument(
        "-s",
        "--remove-spaces",
        dest="remove_whitespaces_mode",
        type=str,
        default="ascii",
        choices=("ascii", "all", "none"),
        help="지울 후행 공백 종류 (default: ascii)",
    )
    ...
    parser.add_argument("--dry-run", action="store_true", help="가상으로 돌려 보기(실제로 스크립트를 작동시키지 않는다)")
