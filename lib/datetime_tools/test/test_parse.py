...
class TestISO8601Parse(unittest.TestCase):
    def test_parse_datetime(self):
        ...
        self.assertEqual(parse_iso8601_datetime("2020-01-02T03:04:56.789012"), datetime(2020, 1, 2, 3, 4, 56, 789012))
        self.assertEqual(
            parse_iso8601_datetime("2020-01-02 03:04:56Z"), datetime(2020, 1, 2, 3, 4, 56, tzinfo=timezone.utc)
        )
        self.assertEqual(
            parse_iso8601_datetime("2020-01-02 03:04:56+09"),
            datetime(2020, 1, 2, 3, 4, 56, tzinfo=timezone(timedelta(hours=9))),
        )
        self.assertEqual(
            parse_iso8601_datetime("2020-01-02 03:04-0930"),
    ...
    def test_parse_datetimespan(self):
        ...
        self.assertEqual(parse_iso8601_datetimespan("PT12H34M56S"), timedelta(hours=12, minutes=34, seconds=56))
        self.assertEqual(
            parse_iso8601_datetimespan("PT12H34M56.789S"), timedelta(hours=12, minutes=34, seconds=56, milliseconds=789)
        )
        self.assertEqual(parse_iso8601_datetimespan("PT12H333.3S"), timedelta(hours=12, seconds=333, milliseconds=300))
